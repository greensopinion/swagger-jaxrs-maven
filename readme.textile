...
This layout combined with the "Web Application":#WebApplication configuration below will enable "Swagger UI":https://helloreverb.com/developers/swagger to interact with the services.
